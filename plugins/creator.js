...
let handler = async (m, { conn }) => {
   this.sendContact(m.chat, '6289696454872', 'Ikal', m)
...
const buttonMessage = {contentText: 'Hallo Kak 👋\n\nSaya Adalah Pemilik Bot ini\nMau ingin Tau Tentang Apa Yah Kak?', footerText: 'Created By Ikal Officiall ❤', buttons: buttons, headerType: 1}
// PEMBATAS YOO //
   await conn.sendContact(m.chat, '6289696454872', 'ᴀᴅɪ ᴏғғɪᴄɪᴀʟあ', m)
   await time(1000)
